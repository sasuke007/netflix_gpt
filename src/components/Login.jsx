...
const Login = () => {
    ...
    return (
        <div className="relative flex flex-col h-screen w-screen">
            ...
            <div
                className="z-10 login-form absolute p-20 top-1/4 left-1/3 text-white flex justify-center items-center bg-gray-800 bg-opacity-80 w-1/3 h-2/3">
                <form className="flex flex-col flex-auto content-around">
                    ...
                    { !isSignInForm && <input type="text" placeholder="Name" className="p-2 m-3 w-full bg-gray-900 rounded-lg"/>}
                    ...
                    <button className="p-2 m-3 w-full bg-red-700 rounded-lg">{isSignInForm ? "Sign In" : "Sign Up"}</button>
